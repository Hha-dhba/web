...
# Import hàm khởi tạo từ file mới
from controllers.global_state import init_global_system

# Bung các controller ra thành các biến toàn cục cho toàn bộ người dùng xài chung
(auth_controller, movie_controller, showtime_controller, 
 room_controller, booking_controller, admin_controller) = init_global_system()
